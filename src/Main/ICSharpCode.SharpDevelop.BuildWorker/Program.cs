...
namespace ICSharpCode.SharpDevelop.BuildWorker
{
    class Program
    {
        ...
        bool DoBuild()
        {
            ...
            // Use MSBuild to build 4.0 projects
            if(SDLite.BuildHelper.IsProject40(project.Xml))
                return new SDLite.BuildWorker.MSBuild40(this).BuildProject(project, currentJob);
        ...
        internal void HostReportEvent(BuildEventArgs e)
        {
            if (host != null) {
